...
{
	uint8 Local_u8RowCounter, Local_u8ColCounter, Local_u8KeyState, Local_u8PressedKey = KDP_u8NO_PRESSED_KEY_VAL;
	
	static uint8 Local_u8ColArr[COL_NUM] = {KPD_u8C0_PIN, KPD_u8C1_PIN, KPD_u8C2_PIN, KPD_u8C3_PIN};
	static uint8 Local_u8RowArr[COL_NUM] = {KPD_u8R0_PIN, KPD_u8R1_PIN, KPD_u8R2_PIN, KPD_u8R3_PIN};
	...
	for(Local_u8ColCounter = 0u ; Local_u8ColCounter < COL_NUM ; Local_u8ColCounter++)
	{
		...
		// Read the row pins
		for(Local_u8RowCounter = 0u ; Local_u8RowCounter < COL_NUM ; Local_u8RowCounter++)
		{
